...
export default function SiteShell({children}: {children: React.ReactNode}) {
 ...
 <a className="btn btn-gold" href="/home/booking">Book a Space →</a></nav>
 ...
 {showNote && <div className="demo-note" role="note"><span>⚑</span><span><b>Demo preview.</b> Sample imagery, rates and availability for review. Bookings are not live.</span><button className="x" aria-label="Dismiss preview notice" onClick={()=>setShowNote(false)}>×</button></div>}
 </div>;
}
